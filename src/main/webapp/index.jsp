...
<form action="main/upload_file" method="post" enctype="multipart/form-data">
    选择文件:<input type="file" name="file">
    <input type="submit" value="提交">
</form>
<%--<form id="course-form" method="post" action="c_course" enctype="multipart/form-data">--%>
<%--选择文件:<input type="file" name="file">--%>
<%--<input type="submit" value="提交">--%>
<%--</form>--%>

<textarea style="float: left" id="content" cols="50" rows="5"></textarea>
